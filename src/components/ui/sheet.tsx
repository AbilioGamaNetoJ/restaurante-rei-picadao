...
function SheetTrigger({ nativeButton = false, ...props }: Readonly<SheetPrimitive.Trigger.Props>) {
  return <SheetPrimitive.Trigger data-slot="sheet-trigger" nativeButton={nativeButton} {...props} />
}

function SheetClose({ nativeButton = true, ...props }: Readonly<SheetPrimitive.Close.Props>) {
